...
deploy-docs:
	@echo "Building and deploying docs to forkstack.xyz..."
	@uv run mkdocs build
	@wrangler pages deploy site --project-name forkstack --commit-dirty=true
	@echo "✓ Deployed to https://forkstack.xyz"
...
help:
	...
	@echo "    make deploy-docs- Deploy docs to forkstack.xyz"
	@echo ""
	@echo "  Combined:"
